...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "12c402faedc633ae10deb6fad4458c01177ab1f3";
    hash = "sha256-PzZcfxqKxcxilrI0jsscc+QL1ykGzAT4+gB3bZDYr8w=";
  };
  vendorHash = "sha256-MshbKAR9NqfLWbA0j9TXWVGsbP7F2/FeQzSNkf5LknQ=";
  proxyVendor = true;
