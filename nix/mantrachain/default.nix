...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "13377aaf4bf2799d37e64cad55cff08d4b93b06a";
    hash = "sha256-tH9w5SXkrT6O2X3XjHSm/9m+9T1cErhkrP0uJxMDAEQ=";
  };
  vendorHash = "sha256-orCNzMt4Uo3m83o6R8UsAQjgsRXQTp3psbJBKNMTQm4=";
  proxyVendor = true;
