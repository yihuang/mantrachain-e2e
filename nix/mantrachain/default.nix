...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "9d1c344a75f24bccfe33e97fd56d6c4fe6714224";
    hash = "sha256-RHpl8gW4atgHqD6VdzjkvML5VeXMQofa58d35urt5qo=";
  };
  vendorHash = "sha256-/NJeCycG+dz2vPjVEBEBtxrNv+1zpIhNK3eTkPNbIS8=";
  proxyVendor = true;
