...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "mmsqe";
    repo = pname;
    rev = "f56414e8588001c7729a7f93462dc92d41a81a0d";
    hash = "sha256-bDB3JhJJZUcYRxrpdwNxn0RSVmrgSA5zkhY01apFIxk=";
  };
  vendorHash = "sha256-o3MOYpiDGVjgJU8nm0g/9C+mWQP9zxMXn/Jo1HdEnJU=";
  proxyVendor = true;
