...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "mmsqe";
    repo = pname;
    rev = "a30d44fe099b42a179281f2d64e54ddd1c84f957";
    hash = "sha256-gAiqmDvQIWwl1tLihUqdUQOlj54J1hDxbCN3oRR1r0s=";
  };
  vendorHash = "sha256-kWo3Pev+d+A4xdS0XyAVv7z3svIRxdAunrhqlWhHivU=";
  proxyVendor = true;
