...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "bf1395c520d40a94c7da5ae2813a1c92e35f0846";
    hash = "sha256-zOjWIJMidHEJHPefNmv+dRKaPwodM3LnIDfoITF9ZSo=";
  };
  vendorHash = "sha256-EDE36Bkp6jzS3rCg6dTiS22+3uGpL9QZtUjR8fPaErU=";
  proxyVendor = true;
