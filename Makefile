...
test-e2e-nix-skip-mantrachaind-build:
	@nix-shell ./integration_tests/shell.nix --arg includeMantrachaind false --run "TESTS_TO_RUN=all INCLUDE_MAIN_MANTRACHAIND=false ./scripts/run-integration-tests.sh"
